...
for fold, (train_ids, val_ids) in enumerate(kfold.split(full_dataset)):
    ...
    scheduler = optim.lr_scheduler.ReduceLROnPlateau(optimizer, mode='min', factor=0.85, patience=5) # This will reduce the learning rate by 15% after {patience} consecutive epochs without validation loss improvement
